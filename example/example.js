...
(function(exports) {
  ...
  var toRGBA$prime = function (v) {
      ...
      var col = (function () {
          ...
          throw new Error("Failed pattern match at Color line 301, column 5 - line 306, column 61: " + [  ]);
      })();
      return {
          r: col.r + m, 
          g: col.g + m, 
...
(function(exports) {
  ...
  var target = function (dictIsEvent) {
      return function ($15) {
          return DOM_Event_Event.target(toEvent(dictIsEvent)($15));
      };
  };                                                                                                                     
  var isEventTouchEvent = new IsEvent(DOM_Classy_Util.fromAny(DOM_Event_Types.readTouchEvent), DOM_Event_Types.touchEventToEvent);         
  ...
  exports["isEventTouchEvent"] = isEventTouchEvent;
...
})(PS["DOM.Event.TouchEvent"] = PS["DOM.Event.TouchEvent"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["DOM.Event.TouchEvent"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var DOM_Event_Types = PS["DOM.Event.Types"];
  var Data_Foreign = PS["Data.Foreign"];
  var Data_Maybe = PS["Data.Maybe"];
  ...
  exports["clientX"] = $foreign.clientX;
  exports["clientY"] = $foreign.clientY;
  exports["touches"] = $foreign.touches;
})(PS["DOM.Event.TouchEvent"] = PS["DOM.Event.TouchEvent"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var DOM_Event_TouchEvent = PS["DOM.Event.TouchEvent"];
  var DOM_Event_Types = PS["DOM.Event.Types"];
  var DOM_HTML_Types = PS["DOM.HTML.Types"];
  var Data_Either = PS["Data.Either"];
  var Data_EuclideanRing = PS["Data.EuclideanRing"];
  ...
  var StartUpdateColor = (function () {
      function StartUpdateColor(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      StartUpdateColor.create = function (value0) {
          return function (value1) {
              return new StartUpdateColor(value0, value1);
          };
      };
      return StartUpdateColor;
  })();
  var EndUpdateColor = (function () {
      function EndUpdateColor(value0) {
          this.value0 = value0;
      };
      EndUpdateColor.create = function (value0) {
          return new EndUpdateColor(value0);
      };
      return EndUpdateColor;
  })();
  var UpdateColor = (function () {
      function UpdateColor(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateColor.create = function (value0) {
          return function (value1) {
              return new UpdateColor(value0, value1);
          };
      };
      return UpdateColor;
  })();
  ...
  var ColorDrag = (function () {
      ...
      ColorDrag.value = new ColorDrag();
      return ColorDrag;
  })();
  var positionInRect = function (v) {
      return function (v1) {
          return {
              x: ((v.x - v1.left) / v1.width) * 100.0, 
              y: ((v.y - v1.top) / v1.height) * 100.0
          };
      };
  };

  // data Condition = Idle | ColorDrag | HueDrag
  var orDefault = Data_Maybe.fromMaybe(Color.hsl(180.0)(0.0)(0.0));
  var getHue = function ($52) {
      return (function (v) {
          return v.h;
      })(Color.toHSLA($52));
  };
  var pureHue = function (c) {
      return Color.hsl(getHue(c))(1.0)(0.5);
  };
  var render = function (v) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-color" ]), Halogen_HTML_CSS.style(CSS_Background.backgroundColor(pureHue(orDefault(v.color)))), Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input(function ($53) {
          return StartUpdateColor.create(Data_Either.Right.create($53));
      })), Halogen_HTML_Events.onMouseMove(Halogen_HTML_Events.input(function ($54) {
          return UpdateColor.create(Data_Either.Right.create($54));
      })), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(EndUpdateColor.create)), Halogen_HTML_Events.onTouchStart(Halogen_HTML_Events.input(function ($55) {
          return StartUpdateColor.create(Data_Either.Left.create($55));
      })), Halogen_HTML_Events.onTouchMove(Halogen_HTML_Events.input(function ($56) {
          return UpdateColor.create(Data_Either.Left.create($56));
      })), Halogen_HTML_Events.onTouchEnd(Halogen_HTML_Events.input_(EndUpdateColor.create)) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-saturation" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-brightness" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-sbSelector" ]), Halogen_HTML_CSS.style((function () {
          if (v.color instanceof Data_Maybe.Nothing) {
              return CSS_Display.display(CSS_Display.displayNone);
          };
          if (v.color instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(v.color.value0))(function () {
                  return CSS_Border.borderColor((function () {
                      var $25 = Color.isLight(v.color.value0);
                      if ($25) {
                          return Color.black;
                      };
                      return Color.white;
          ...
          throw new Error("Failed pattern match at ColorPicker.Halogen.Component line 121, column 24 - line 127, column 31: " + [ v.color.constructor.name ]);
      })()) ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-hue" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ColorPicker-hSelector" ]), (function () {
          var hue = getHue(orDefault(v.color));
          return Halogen_HTML_CSS.style(CSS_Geometry.top(CSS_Size.pct((hue / 360.0) * 100.0)));
      })() ])([  ]) ]) ]);
  };
  var applyRect = function (dictIsEvent) {
      return function (e) {
          return function (input) {
              var elem = DOM_Classy_Node.fromNode(DOM_Classy_Node.isNodeHTMLElement)(DOM_Classy_Event.target(dictIsEvent)(e));
              var rect = Data_Functor.map(Data_Maybe.functorMaybe)(DOM_Classy_HTMLElement.getBoundingClientRect(DOM_Classy_HTMLElement.isHTMLElementHTMLElement))(elem);
              if (rect instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(input);
              };
              if (rect instanceof Data_Maybe.Just) {
                  return Data_Functor.map(Control_Monad_Eff.functorEff)(positionInRect(input))(rect.value0);
              };
              throw new Error("Failed pattern match at ColorPicker.Halogen.Component line 82, column 5 - line 84, column 43: " + [ rect.constructor.name ]);
          };
      };
  };
  var mouseEventToPosition = function (e) {
      return applyRect(DOM_Classy_Event.isEventMouseEvent)(e)({
          x: Data_Int.toNumber(DOM_Event_MouseEvent.clientX(e)), 
          y: Data_Int.toNumber(DOM_Event_MouseEvent.clientY(e))
      });
  };
  var touchEventToPosition = function (e) {
      var fstTouch = DOM_Event_TouchEvent.item(0)(DOM_Event_TouchEvent.touches(e));
      if (fstTouch instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)({
              x: 0.0, 
              y: 0.0
          });
      };
      if (fstTouch instanceof Data_Maybe.Just) {
          return applyRect(DOM_Classy_Event.isEventTouchEvent)(e)({
              x: Data_Int.toNumber(DOM_Event_TouchEvent.clientX(fstTouch.value0)), 
              y: Data_Int.toNumber(DOM_Event_TouchEvent.clientY(fstTouch.value0))
          });
      };
      throw new Error("Failed pattern match at ColorPicker.Halogen.Component line 91, column 5 - line 95, column 42: " + [ fstTouch.constructor.name ]);
  };
  var posFromEvent = Data_Either.either(touchEventToPosition)(mouseEventToPosition);
  var $$eval = function (dictMonadEff) {
      return function (v) {
          if (v instanceof NoOp) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          };
          if (v instanceof StartUpdateColor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $34.condition = ColorDrag.value;
                  return $34;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(posFromEvent(v.value0)))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Debug_Trace.traceAnyA(Debug_Trace.warn())(Halogen_Query_HalogenM.applicativeHalogenM)(v1))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              });
          };
          if (v instanceof EndUpdateColor) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $40 = {};
                  for (var $41 in v1) {
                  ...
                  $40.condition = Idle.value;
                  return $40;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof UpdateColor) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.condition instanceof ColorDrag) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(posFromEvent(v.value0)))(function (v2) {
                              return Debug_Trace.traceAnyA(Debug_Trace.warn())(Halogen_Query_HalogenM.applicativeHalogenM)(v2);
                          });
                      };
          ...
          throw new Error("Failed pattern match at ColorPicker.Halogen.Component line 147, column 1 - line 147, column 60: " + [ v.constructor.name ]);
      };
  };
  var picker = function (dictMonadEff) {
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          ...
          render: render, 
          "eval": $$eval(dictMonadEff), 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  };
  exports["Idle"] = Idle;
  exports["ColorDrag"] = ColorDrag;
  exports["NoOp"] = NoOp;
  exports["StartUpdateColor"] = StartUpdateColor;
  exports["EndUpdateColor"] = EndUpdateColor;
  exports["UpdateColor"] = UpdateColor;
  exports["applyRect"] = applyRect;
  exports["getHue"] = getHue;
  exports["mouseEventToPosition"] = mouseEventToPosition;
  exports["orDefault"] = orDefault;
  exports["picker"] = picker;
  exports["posFromEvent"] = posFromEvent;
  exports["positionInRect"] = positionInRect;
  exports["pureHue"] = pureHue;
  exports["render"] = render;
  exports["touchEventToPosition"] = touchEventToPosition;
})(PS["ColorPicker.Halogen.Component"] = PS["ColorPicker.Halogen.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
...
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var ColorPicker_Halogen_Component = PS["ColorPicker.Halogen.Component"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  ...
  var HandleMsg = (function () {
      function HandleMsg(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleMsg.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleMsg(value0, value1, value2);
              };
          };
      };
      return HandleMsg;
  ...
  var cpColor = Halogen_Component_ChildPath.cp1;
  var render = function (dictMonadEff) {
      return function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Picker 1") ]), Halogen_HTML["slot'"](cpColor)(0)(ColorPicker_Halogen_Component.picker(dictMonadEff))(Data_Unit.unit)(Halogen_HTML_Events.input(HandleMsg.create(0))) ]);
      };
  };
  var example = function (dictMonadEff) {
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordInt)(Data_Ord.ordVoid))({
          initialState: Data_Function["const"]({}), 
          render: render(dictMonadEff), 
          "eval": $$eval, 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(example(Control_Monad_Aff.monadEffAff))(Data_Unit.unit)(v);
  }));
  exports["HandleMsg"] = HandleMsg;
  exports["cpColor"] = cpColor;
  exports["eval"] = $$eval;
